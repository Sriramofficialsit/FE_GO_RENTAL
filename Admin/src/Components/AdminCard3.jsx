...
const AdminCard3 = ({ carData }) => {
  ...
  return (
    <div className="relative w-full bg-gradient-to-r from-red-50 to-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-[1.01] border-l-4 border-red-500 animate-fade-in">
      <div className="absolute top-3 right-3 bg-red-200 text-red-800 px-3 py-1 rounded-full text-xs font-semibold animate-pulse">
        Disapproved
      </div>
