...
const SearchUser = () => {
  ...
  const deleteUser = async (userId) => {
    ...
    try {
      await axios.delete(
        `https://be-go-rental-hbsq.onrender.com/auth/user-info-del/${userId}`
      );
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      if (!/^\d{12}$/.test(selectedUser.aadhaarNo)) {
        setError("Invalid Aadhaar number");
        return;
      }
      await axios.put(
        `https://be-go-rental-hbsq.onrender.com/auth/user-info-update/${selectedUser._id}`,
        {
          ...
          drivingLicenceNo: selectedUser.drivingLicenceNo,
        }
      );
      setUsers(
        users.map((u) =>
                  ...
                  <form className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      >
                        ...
                        <input
                          ...
                          value={selectedUser.drivingLicenceNo}
                          onChange={handleInputChange}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      >
                        ...
                        {selectedUser.aadhaarFile ? (
                          <a
                            href={`https://be-go-rental-hbsq.onrender.com/${selectedUser.aadhaarFile}`}
                            target="_blank"
                      ...
                      >
                        ...
                        {selectedUser.drivingLicenceFile ? (
                          <a
                            href={`https://be-go-rental-hbsq.onrender.com/${selectedUser.drivingLicenceFile}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-indigo-600 hover:text-indigo-800"
                          >
